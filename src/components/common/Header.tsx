...
const Logo = () => (
  <div className="logo">
    <img src="../images/common/logo.png" alt="Logo" className="w-20" />
  </div>
);
...
export const Header = () => {
  ...
  return (
    <header className={`fixed top-0 w-full bg-white z-50 transition-all ease-in-out duration-300 ${isScrolled ? "shadow-s1 animate-bounceFromTop py-0" : "py-0"}`}>
