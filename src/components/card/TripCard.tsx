  ...
  return (
    <>
      <div className="box rounded-xl shadow-s3" key={item?.id}>
        <div className="h-56">
          <img src={item?.image || "/images/trip/01.jpg"} alt="" className="w-full h-full rounded-t-xl" />
        </div>
        <div className="details p-6">
          <div className="flexc justify-between">
            <h3 className="text-xl font-semibold">{item?.country}</h3>
            <img src={item.flag || "/images/trip/01.jpg"} alt="" />
          </div>
          ...
          <div className="flex gap-3 mt-4">
            <img src={item.avatar || "/images/trip/01.jpg"} alt="" className="w-10 h-10 rounded-full" />
